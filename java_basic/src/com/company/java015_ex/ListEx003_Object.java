...
public class ListEx003_Object {
	...
	//ver-1 if( 0번째의 유저의이름이 "아이언맨"이라면 ){ 사용자의 정보출력 users.get(0) }
	//ver-2 if( users.get(0).getName().equals("아이언맨") ){ 사용자의 정보출력 users.get(0) }
	// 		if( users.get(1).getName().equals("아이언맨") ){ 사용자의 정보출력 users.get(1) }
	// 		if( users.get(2).getName().equals("아이언맨") ){ 사용자의 정보출력 users.get(2) }
