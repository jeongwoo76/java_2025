...
public class PagingDto {
	private int listtotal;   //#1) 전체글 124
	private int onepagelist; //#2) 한페이지에 보여줄 게시물의 수 10
	private int pagetotal;   //#3) 총페이지수 124/10 = 13 12페이지+4글
	...
	public PagingDto(int listtotal, int pstartno) { // pstartno 0 1 2 3 
		super();
		this.listtotal = listtotal;   // 전체계산한 값 124
		this.onepagelist = 10;
		...
		//  13      < 20
		if(this.pagetotal<this.end) {this.end=pagetotal;}
	}
}
